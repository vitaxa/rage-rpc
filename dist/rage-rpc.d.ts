...
export function call<T = any>(name: string, args?: any, options?): Promise<T>;
export function callServer<T = any>(name: string, args?: any, options?): Promise<T>;
export function callClient<T = any>(player: Player, name: string, args?: any, options?): Promise<T>;
export function callClient<T = any>(name: string, args?: any, options?): Promise<T>;
export function callBrowsers<T = any>(player: Player, name: string, args?: any, options?): Promise<T>;
export function callBrowsers<T = any>(name: string, args?: any, options?): Promise<T>;
export function callBrowser<T = any>(browser: Browser, name: string, args?: any, options?): Promise<T>;
